...
#goes through whole dataset and reduces each mesh down to 200 points and saved them in individual tesnors - train and test
#dimension of each tensor = (N, 200, 3) where N is number of objects in train or test set
